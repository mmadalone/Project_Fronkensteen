...
72 automation blueprints. 36 script blueprints. 29 pyscript modules exposing 139 services. 35 YAML packages. 27 voice pipelines across 3 languages. Zero lines of hand-written YAML. All code generated by **Claude** (Anthropic). All images generated by **Google Gemini**.
...
| | Count |
|-|-------|
| Automation blueprints | 72 |
| Script blueprints | 36 |
| YAML packages | 35 |
| Pyscript modules | 29 (exposing 139 services) |
| Assist Pipelines | 27 (5 personas, 4-5 variants each, + 3 native fallbacks) |
...
**Pipeline architecture:** 27 Assist Pipelines total. Each persona has Standard, Bedtime, Music Compose, and Music Transfer variants. Three HA-native fallback pipelines — Davis (English), Joana (Catalan), and Alvaro (Spanish) — provide budget-exhaustion fallback and multilingual coverage.
...
|---------|--------|---------|------|
| [Extended OpenAI Conversation](https://github.com/jekalmin/extended_openai_conversation) | jekalmin | Apache 2.0 | Conversation agent framework — execution backend for all 27 voice pipeline agents |
...
| Component | Role |
|-----------|------|
| HA Voice Assistants (Assist Pipelines) | Centralized pipeline configuration — routing layer for all 27 persona variants |

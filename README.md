...
76 automation blueprints. 36 script blueprints. 29 pyscript modules exposing 141 services. 36 YAML packages. 22 voice pipelines across 3 languages. Zero lines of hand-written YAML. All code generated by **Claude** (Anthropic). All images generated by **Google Gemini**.
...
- **Tier 1 — Pyscript:** 29 Python modules exposing 139 services. Infrastructure: dispatcher, TTS queue, duck manager, memory, presence patterns, routine fingerprinting, music composition, budget tracking.
- **Tier 2 — Blueprints:** 72 automation + 36 script blueprints. User-facing features: bedtime routines, wake-up guards, notification routing, proactive briefings, music control, calendar CRUD, reactive banter.
...
```
├── automation/                    72 automation blueprints

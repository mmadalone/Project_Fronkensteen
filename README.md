...
77 automation blueprints. 35 script blueprints. 37 pyscript modules exposing 155+ services. 40 YAML packages. 22 voice pipelines across 3 languages. ~225 helper entities + 66 runtime state sensors. Zero lines of hand-written YAML. All code generated by **Claude** (Anthropic). All images generated by **Google Gemini**.
...
- **Tier 1 — Pyscript:** 37 Python modules exposing 155+ services. Infrastructure: dispatcher, TTS queue, duck manager, memory, presence patterns, routine fingerprinting, music composition, budget tracking, system health, self-healing recovery, toggle audit, therapy session engine.
...
├── helpers/                       7 helper files (~225 entities)

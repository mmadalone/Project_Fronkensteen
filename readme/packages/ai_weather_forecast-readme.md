...
Provides the helper entity for tomorrow's weather forecast summary, populated by the weather forecast promotion blueprint. This is a minimal package — the forecast logic lives entirely in the blueprint.

## What's Inside

| Type | Count |
|------|-------|
| Input helpers (external) | 1 |
...
- **Helper file:** `helpers_input_text.yaml`
...
- This is the smallest package in the collection — a single input_text helper with a comment header. All logic is in the `weather_forecast_promote.yaml` blueprint.
